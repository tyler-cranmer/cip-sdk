export const trayAbi = [
  ...
  {
    inputs: [],
    name: 'CallerNotAllowedToBuy',
    type: 'error',
  },
  {
    inputs: [],
    name: 'CallerNotAllowedToChangeTrayPrice',
    type: 'error',
  },
  {
    inputs: [
    ...
    outputs: [
      {
        ...
        internalType: 'struct Tray.TileData',
        name: 'tileData',
        type: 'tuple',
      },
    ],
    ...
    outputs: [
      {
        ...
        internalType: 'struct Tray.TileData[7]',
        name: 'tileData',
        type: 'tuple[7]',
      },
    ],
...
// Non Namespace abis for connect wallet button
